...
def get_time_diff():
    ...
    for i in range(len(dataset['got_time'])):
        ...
        day_in_total.append(min(20, abs((signed_time[i]-payed_time[i]).days)))
        hour_in_signed.append(max(7, signed_time[i].hour))
    ...
    times = {
        ...
        'total_day': day_in_total,
        'sign_hour':hour_in_signed
    }
